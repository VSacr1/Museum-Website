...
<head>
    ...
    <style>
        ...
        img {padding: 0.25rem; margin-top: 5px; margin-bottom: 5px; margin-right:5px; border: 1px solid 
        red; border-radius: 0.25rem; float: left; width:20%;}
        .box {border:2px solid green; padding: 5px; float: left; margin-top: 20px; margin-left: 5px;
        margin-right: 5px; margin-bottom: 5px; padding: 20px; width: 90%; height: auto;}
...
<body>
    ...
    <div class = "box">
        <p> Results returned form the flickr with web service: </p>
        <div id="images"></div>
    </div>
